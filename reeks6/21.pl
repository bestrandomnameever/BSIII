# ADSI attributen kan je bekijken in MSDN
# LDAP attributen staan in ADSI Edit

use bind_object;
use Data::Dumper;

my $administrator = bind_object::bind_object("CN=Administrator,CN=Users,DC=iii,DC=hogent,DC=be");

# ADSI Attributen kan je niet overlopen. Waw, echt gewoon waw
